					...
					<div class="col-md-12 text-center">
						<div class="text-homeimage">
							<div class="maintext-image"
								...
								............. Be a Family Member .............</div>
							<div class="subtext-image"
								data-scrollreveal="enter bottom over 1.7s after 0.3s">of
								ACRE</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="row mt-4 mt-50px" style="height: 350px">
			<div class="col-md-12 offset-md-4 " style="justify-content: center;">
				<h3 class="text-center my-8">Sign-up here</h3>
				...
				<div class="card">
					<div class="card-body">
						<form>
							...
							<div class="form-group">
								<label for="email">User E-mail</label> <input type="email"
